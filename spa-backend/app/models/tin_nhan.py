...
class TinNhan(Base):
    ...
    idTinNhan = Column(BigInteger, primary_key=True, autoincrement=True, index=True)
    ...
    thoiGianGui = Column(DateTime, server_default=func.now())
    daXem = Column(Boolean, nullable=False, default=False)
