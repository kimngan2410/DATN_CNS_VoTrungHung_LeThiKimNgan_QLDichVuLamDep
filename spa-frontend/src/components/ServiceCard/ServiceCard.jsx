      ...
      <div className="service-card__content">
        ...
        <div className="service-card__footer">
          ...
          <div className="service-card__actions">
            <Link to={`/dich-vu/${service.id}`} className="service-card__button service-card__button--ghost">
              Chi tiết
            </Link>

            <Link to="/dat-lich" className="service-card__button service-card__button--primary">
              Đặt lịch
            </Link>
          </div>
        </div>
