...
export async function getAdminServiceUsageReportApi({
  fromDate,
  toDate,
  keyword = "",
  category = "Tất cả",
  ...
  const response = await fetch(
    `${API_BASE_URL}/admin-service-usage-report?${params.toString()}`,
    {
      method: "GET",
  ...
  return handleResponse(
    response,
    "Không thể tải báo cáo tình hình sử dụng dịch vụ."
  )
}